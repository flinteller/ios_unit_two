...
class Fighter: Spaceship {
    var weapon = ""
    var remaining_fire_power = 5
    
    func fire() {
        if remaining_fire_power > 0 {
            remaining_fire_power -= 1
        }
        else {
            print("You have any more fire power")
        }
...
destroyer.remaining_fire_power = 10
 ...
 */
//print(falcon.weapon)
print("It does not work because in the main class does not inheret things from the sub class and weapon is defined in the sub class")
 ...
 */
print(destroyer.remaining_fire_power)
destroyer.fire()
print(destroyer.remaining_fire_power)
destroyer.fire()
print(destroyer.remaining_fire_power)
