 ...
 */
if let days_in_January = months["January"] {
    print("January has \(days_in_January) days")
}
...
let shapes_with_colors: [String: [String]] = ["Shapes": shapesArray, "Colors": colorsArray]
print(shapes_with_colors)
 ...
 */
var color = shapes_with_colors["Colors"]
var last_element = color?.last
print(last_element!)
