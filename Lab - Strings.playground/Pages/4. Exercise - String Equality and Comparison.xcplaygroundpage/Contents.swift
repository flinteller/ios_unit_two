...
if nameInCapsLowered == name {
    print("\(nameInCapsLowered) and \(nameLowered) are the same")
}
else {
    print("\(nameInCapsLowered) and \(nameLowered) are not the same")
}
